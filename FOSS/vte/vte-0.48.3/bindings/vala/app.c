/* app.c generated by valac 0.36.3, the Vala compiler
	...
	if (_tmp28_ != 0) {
		{
			...
			if (!_tmp29_) {
				...
				GRegex* _tmp49_ = NULL;
				const gchar* _tmp50_;
				GRegexCompileFlags _tmp51_;
				GRegex* _tmp52_;
				GRegex* _tmp53_;
				flags = G_REGEX_OPTIMIZE | G_REGEX_MULTILINE;
				_tmp47_ = caseless;
				if (_tmp47_) {
					GRegexCompileFlags _tmp48_;
					_tmp48_ = flags;
...
void test_search_popover_set_terminal (TestSearchPopover* self, VteTerminal* value) {
	g_return_if_fail (self != NULL);
	if (test_search_popover_get_terminal (self) != value) {
		VteTerminal* _tmp0_;
		VteTerminal* _tmp1_;
		_tmp0_ = value;
...
TestWindow* test_window_construct (GType object_type, TestApp* app) {
	...
	VteTerminal* _tmp12_;
	GPropertyAction* _tmp13_;
	GPropertyAction* _tmp14_;
	GPropertyAction* _tmp15_;
	VteTerminal* _tmp16_;
	GtkToggleButton* _tmp17_;
	TestSearchPopover* _tmp18_;
	TestSearchPopover* _tmp19_;
	...
	gint _tmp86_;
	VteTerminal* _tmp87_;
	VteCursorBlinkMode _tmp88_;
	VteTerminal* _tmp89_;
	VteCursorShape _tmp90_;
	VteTerminal* _tmp91_;
	VteTerminal* _tmp92_;
	gboolean _tmp93_;
	VteTerminal* _tmp94_;
	...
	gint _tmp97_;
	const gchar* _tmp98_;
	VteTerminal* _tmp103_;
	GdkRGBA _tmp104_ = {0};
	GdkRGBA _tmp105_ = {0};
	VteTerminal* _tmp106_;
	GdkRGBA* _tmp107_;
	GdkRGBA* _tmp108_;
	VteTerminal* _tmp109_;
	GdkRGBA* _tmp110_;
	GdkRGBA* _tmp111_;
	VteTerminal* _tmp112_;
	GdkRGBA* _tmp113_;
	GdkRGBA* _tmp114_;
	VteTerminal* _tmp115_;
	GdkRGBA* _tmp116_;
	GdkRGBA* _tmp117_;
	gboolean _tmp118_;
	gchar** _tmp120_;
	...
	GtkBox* _tmp122_;
	VteTerminal* _tmp123_;
	VteTerminal* _tmp124_;
	VteTerminal* _tmp125_;
	gboolean _tmp126_;
	GError * _inner_error_ = NULL;
	...
	if (_tmp98_ != NULL) {
		...
		VteTerminal* _tmp101_;
		PangoFontDescription* _tmp102_;
