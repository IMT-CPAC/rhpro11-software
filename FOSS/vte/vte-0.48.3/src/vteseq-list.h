...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_iterm2_1337)
...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_reset_cursor_background_color)
...
VTE_SEQUENCE_HANDLER(vte_sequence_handler_urxvt_777)
