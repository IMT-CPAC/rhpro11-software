...
Please refer to the README.txt file in $(GLib_src_root)\build\win32\vs15 on how to build
...
<root>\vs15\<PlatformName>\include, if not already done so.
...
-For both methods PKG_CONFIG_PATH is by default $(PREFIX)\lib\pkgconfig, where $(PREFIX)
 is by default <parent_dir_of_G-I_srcroot>\vs15\<PlatformName>.  If searching from
...
files to <root>\vs15\<PlatformName>\share\gir-1.0 (.gir files) and <root>\vs15\<PlatformName>\lib\girepository-1.0
(.typelib files)
...
<root>\vs15\<PlatformName>\lib and gobject-introspection headers into
<root>\vs15\<PlatformName>\include\gobject-introsection-1.0.
